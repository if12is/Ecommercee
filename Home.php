		...
		?>
			<div class="row">
				...
				foreach ($items as $item) {
					echo '<div class="col-lg-4 col-md-6 text-center position-relative">';
					...
					echo '<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>';
					echo '</div>';
					echo '</div>';
				}
				?>
				...
				<div class="testimonial-sliders">
					<div class="single-testimonial-slider">
						<div class="client-avater">
							<img src="themes/img/avaters/avatar1.png" alt="">
						</div>
					...
					<div class="single-testimonial-slider">
						<div class="client-avater">
							<img src="themes/img/avaters/avatar2.png" alt="">
						</div>
						<div class="client-meta">
					...
					<div class="single-testimonial-slider">
						<div class="client-avater">
							<img src="themes/img/avaters/avatar3.png" alt="">
						</div>
						<div class="client-meta">
